            ...
            <div class="input-wrap">
                <div class="latlng-wrap">
                    <div class="form-field lat-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="cbn_lat" name="cbn_lat"
                               value="<?php echo esc_attr($term_lat) ? esc_attr($term_lat) : ''; ?>">
                    </div>
                    <div class="form-field lng-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="cbn_lng" name="cbn_lng"
                               value="<?php echo esc_attr($term_lng) ? esc_attr($term_lng) : ''; ?>">
                    </div>
                    <div class="form-field zoom-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="cbn_zoom" name="cbn_zoom"
                               value="<?php echo esc_attr($term_zoom) ? esc_attr($term_zoom) : ''; ?>">
                    </div>
                </div>
                ...
                <div class="geo-coordinates-hint">
                    ...
                    <ol>
                        ...
                        <li><?php echo __('Zoom and pan the map to set the perfect initial view', 'compass'); ?><br><br><strong><?php echo __('Tip:', 'compass'); ?></strong> <?php echo __('Hold down the Shift key + mouse to zoom in on an area.', 'compass'); ?>
                        </li>
                    </ol>
                </div>
            </div>
