            ...
            <div class="input-wrap">
                <div class="latlng-wrap">
                    <div class="form-field lat-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="oum_lat" name="oum_lat"
                    ...
                    <div class="form-field lng-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="oum_lng" name="oum_lng"
                    ...
                    <div class="form-field zoom-wrap">
                        ...
                        <input type="text" readonly class="widefat" id="oum_zoom" name="oum_zoom"
