<table class="form-table">
    <tbody>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" class="regular-text" id="oum_location_address" name="oum_location_address" value="<?php echo esc_attr($address); ?>"></input>
            </td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <a href="#" class="oum_upload_image_button button button-secondary"><?php echo __('Upload Image', 'open-user-map'); ?></a>
                <input type="hidden" id="oum_location_image" name="oum_location_image" value="<?php echo esc_attr($image); ?>"></input>
                <br><br>
        ...
        <?php if ( oum_fs()->is__premium_only() ): ?>
            <?php if ( oum_fs()->can_use_premium_code() ): ?>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" class="regular-text" id="oum_location_video" name="oum_location_video" placeholder="YouTube or Vimeo URL" value="<?php echo esc_attr($video); ?>"></input>
                        <br><br>
        ...
        <tr valign="top">
            ...
            <td>
                <a href="#" class="oum_upload_audio_button button button-secondary"><?php echo __('Upload Audio', 'open-user-map'); ?></a>
                <input type="hidden" id="oum_location_audio" name="oum_location_audio" value="<?php echo esc_attr($audio); ?>"></input>
                <br><br>
            ...
            <?php foreach($active_custom_fields as $index => $custom_field): ?>
                ...
                <?php if($custom_field['fieldtype'] == 'email'): ?>
                    ...
                    <tr valign="top" class="section-id_cf-<?php echo $index; ?>">
                        ...
                        <td>
                            <input type="email" class="regular-text" name="oum_location_custom_fields[<?php echo $index; ?>]" value="<?php echo isset($meta_custom_fields[$index]) ? esc_attr($meta_custom_fields[$index]) : ''; ?>"></input>
                            <?php echo $description; ?>
                        </td>
                    </tr>
                        ...
                        <td>
                            <fieldset>
                                ...
                                <?php foreach($options as $option): ?>
                                    <div>
                                        <label>
                                            <input type="checkbox" name="oum_location_custom_fields[<?php echo $index; ?>][]" value="<?php echo esc_attr($option); ?>" <?php echo (isset($meta_custom_fields[$index]) && (is_array($meta_custom_fields[$index])) && in_array(esc_attr($option), $meta_custom_fields[$index])) ? 'checked' : ''; ?>>
        ...
        <?php if (oum_fs()->is__premium_only()): ?>
            <?php if (oum_fs()->can_use_premium_code()): ?>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input class="oum-switch" type="checkbox" id="oum_location_notification" name="oum_location_notification" <?php echo ($notification) ? 'checked' : ''; ?>>
                        ...
                        <input type="text" class="regular-text" id="oum_location_author_name" name="oum_location_author_name" value="<?php echo esc_attr($author_name); ?>"></input>
                        <br><br>

                        <label class="meta-label" for="oum_location_author_email">
                            <?php echo $text_notify_me_on_publish_email; ?>
                        </label>
                        <input type="email" class="regular-text" id="oum_location_author_email" name="oum_location_author_email" value="<?php echo esc_attr($author_email); ?>"></input>
                        <br><br>
