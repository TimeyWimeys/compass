<table class="form-table">
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            <div class="geo-coordinates-wrap">
                        ...
                        <div class="latlng-wrap" id="latLngInputs" style="display: none;">
                            ...
                            <div>
                                <div>
                                    ...
                                    <input type="text" class="widefat" id="cbn_location_lat" name="cbn_location_lat"
                                ...
                                <div>
                                    ...
                                    <input type="text" class="widefat" id="cbn_location_lng" name="cbn_location_lng"
                ...
                wp_enqueue_script('cbn_backend_location_js', esc_url($this->plugin_url) . 'src/js/backend-location.js', ['cbn_leaflet_providers_js', 'cbn_leaflet_markercluster_js', 'cbn_leaflet_subgroups_js', 'cbn_leaflet_geosearch_js', 'cbn_leaflet_locate_js', 'cbn_leaflet_fullscreen_js', 'cbn_leaflet_search_js', 'cbn_leaflet_gesture_js', 'wp-i18n', 'cbn_global_leaflet_js'], esc_attr($this->plugin_version));
                ?>
            </div>
        </td>
    </tr>
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            <label for="cbn_location_address"></label><input type="text" class="regular-text" id="cbn_location_address"
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            <a href="#"
               class="cbn_upload_image_button button button-secondary"><?php echo __('Upload Image', 'compass'); ?></a>
            <input type="hidden" id="cbn_location_image" name="cbn_location_image"
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            <label for="cbn_location_video"></label><input type="text" class="regular-text" id="cbn_location_video"
                                                           name="cbn_location_video" placeholder="YouTube or Vimeo URL"
                                                           value="<?php echo esc_attr($video); ?>">
            <br><br>
            <div id="cbn_location_video_preview" class="<?php echo $has_video; ?>">
                <?php echo $video_tag; ?>
                <div onclick="cbn_RemoveVideoUpload()" class="remove-upload">&times;</div>
            </div>
        </td>
    </tr>
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            <a href="#"
               class="cbn_upload_audio_button button button-secondary"><?php echo __('Upload Audio', 'compass'); ?></a>
            <input type="hidden" id="cbn_location_audio" name="cbn_location_audio"
                    ...
                    <td>
                        <fieldset>
                            ...
                            <?php foreach ($options as $option) : ?>
                                <div>
                                    <label>
                                        <input type="radio" name="cbn_location_custom_fields[<?php echo $index; ?>]"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    <input class="cbn-switch" type="checkbox" id="cbn_location_notification"
                           name="cbn_location_notification" <?php echo ($notification) ? 'checked' : ''; ?>>
                    ...
                    <input type="text" class="regular-text" id="cbn_location_author_name"
                           name="cbn_location_author_name" value="<?php echo esc_attr($author_name); ?>">
                    <br><br>

                    <label class="meta-label" for="cbn_location_author_email">
                        <?php echo $text_notify_me_on_publish_email; ?>
                    </label>
                    <input type="email" class="regular-text" id="cbn_location_author_email"
                           name="cbn_location_author_email" value="<?php echo esc_attr($author_email); ?>">
                    <br><br>
