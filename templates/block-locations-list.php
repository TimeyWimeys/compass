    ...
    while ($locations_query->have_posts()) : $locations_query->the_post();
        ...
        if (is_array($meta_custom_fields) && is_array($active_custom_fields)) {
            ...
            foreach ($active_custom_fields as $index => $active_custom_field) {
                ...
                if (isset($active_custom_field['private'])) continue;
        ...
        <?php foreach ($locations_list as $location): ?>
            ...
            if ($location['image']) {
                ...
                if (count($images) > 1) {
                    ...
                    $media_tag = '<div class="oum_location_image"><img class="skip-lazy" src="' . esc_url_raw($absolute_image_url) . '" alt=""></div>';
                }
            }
            ...
            if (true):
                if (true):
                    ...
                    if ($location['video']) {
                        ...
                        $media_tag = '<div class="oum_location_video"><div>' . $video_embed . '</div></div>';
                    }
