<div class="Compass cbn-container-for-fullscreen">
        ...
        <div class="location-overlay-content">
            ...
            <form id="cbn_add_location" enctype="multipart/form-data">
                ...
                <?php if (get_option('cbn_enable_title', 'on')) : ?>
                    ...
                    ?>
                    <label for="cbn_location_title"></label><input type="text" id="cbn_location_title"
                                                                   name="cbn_location_title"
                        <?php
                        if (get_option('cbn_title_required', 'on')) :
                            ?>
                            required<?php endif; ?> placeholder="<?php echo $cbn_title_label; ?>
				<?php
                    if (get_option('cbn_title_required', 'on')) :
                        ?>
				*<?php endif; ?>" <?php echo $maxlength; ?> />
                <?php endif; ?>
                ...
                <input type="hidden" id="cbn_location_lat" name="cbn_location_lat" required
                       placeholder="<?php echo __('Latitude', 'compass'); ?>*"/>
                <input type="hidden" id="cbn_location_lng" name="cbn_location_lng" required
                       placeholder="<?php echo __('Longitude', 'compass'); ?>*"/>
                ...
                <?php if (get_option('cbn_enable_marker_types') && $types) : ?>
                    ...
                    <?php if (get_option('cbn_enable_multiple_marker_types')) : ?>
                        ...
                        <fieldset id="cbn_marker_icon">
                            ...
                            foreach ($types as $tag) :
                                ...
                                <div>
                                    <label>
                                        <input style="accent-color: <?php echo $cbn_ui_color; ?>" type="checkbox"
                                               name="cbn_marker_icon[]" value="<?php echo $tag->term_id; ?>">
                    ...
                    <?php else : ?>
                        ...
                        <label for="cbn_marker_icon"></label><select name="cbn_marker_icon[]" id="cbn_marker_icon">
                ...
                <?php if (is_array($cbn_custom_fields)) : ?>
                    <div class="cbn_custom_fields_wrapper">
                        <?php foreach ($cbn_custom_fields as $index => $custom_field) : ?>
                            ...
                            $html = ($custom_field['html']) ?: '';
                            ?>

                            <?php if ($custom_field['fieldtype'] == 'text') : ?>
                                <div>
                                    <label>
                                        <input type="text" name="cbn_location_custom_fields[<?php echo $index; ?>]"
                            ...
                            <?php if ($custom_field['fieldtype'] == 'link') : ?>
                                <div>
                                    <label>
                                        <input type="url" name="cbn_location_custom_fields[<?php echo $index; ?>]"
                                               placeholder="<?php echo $label; ?>" <?php echo (isset($custom_field['required'])) ? 'required' : ''; ?>
                                               value="" <?php echo $maxlength; ?> />
                                    </label>
                                    <?php echo $description; ?>
                            ...
                            <?php if ($custom_field['fieldtype'] == 'email') : ?>
                                <div>
                                    <label>
                                        <input type="email" name="cbn_location_custom_fields[<?php echo $index; ?>]"
                                               placeholder="<?php echo $label; ?>" <?php echo (isset($custom_field['required'])) ? 'required' : ''; ?>
                                               value="" <?php echo $maxlength; ?> />
                                    </label>
                                    <?php echo $description; ?>
                            ...
                            <?php if ($custom_field['fieldtype'] == 'checkbox') : ?>
                                <div>
                                    <fieldset
                                        ...
                                        <?php
                                        $options = isset($custom_field['options']) ? explode('|', $custom_field['options']) : [];
                                        foreach ($options as $option) :
                                            ?>
                                            <div>
                                                <label>
                                                    <input style="accent-color: <?php echo $cbn_ui_color; ?>"
                                                           type="checkbox"
                                                           name="cbn_location_custom_fields[<?php echo $index; ?>][]"
                ...
                <?php if (get_option('cbn_enable_address', 'on') === 'on') : ?>
                    <label for="cbn_location_address"></label><input type="text" id="cbn_location_address"
                                                                     name="cbn_location_address"
                                                                     placeholder="<?php echo $cbn_address_label; ?>"/>
                <?php endif; ?>

                <?php if (get_option('cbn_enable_description', 'on') === 'on') : ?>
                    <label for="cbn_location_text"></label><textarea id="cbn_location_text" name="cbn_location_text"
                                                                     placeholder="<?php echo $cbn_description_label; ?><?php echo (get_option('cbn_description_required')) ? '*' : ''; ?>" <?php echo (get_option('cbn_description_required')) ? 'required' : ''; ?>></textarea>
                <?php endif; ?>
                ...
                <div class="cbn_media">
                    <?php if (get_option('cbn_enable_image', 'on') === 'on') : ?>
                        <div class="media-upload cbn-image-upload">
                            ...
                            <input type="file"
                                   ...
                                   multiple
                                <?php
                                if (get_option('cbn_image_required')) :
                                    ?>
                                    required<?php endif; ?>
                                   data-max-files="5"
                            />
                            ...
                            <input type="hidden" id="cbn_remove_existing_image" name="cbn_remove_existing_image"
                                   value="0"/>
                        </div>
                    ...
                    <?php if (get_option('cbn_enable_video') === 'on') : ?>
                        <div class="media-upload cbn-video-upload">
                            <label style="color: #e02aaf" for="cbn_location_video"
                                   title="<?php echo __('YouTube or Vimeo Video', 'compass'); ?>">
                                <span class="dashicons dashicons-format-video"></span>
                            </label>
                            <input type="text" id="cbn_location_video" name="cbn_location_video"
                                   placeholder="<?php echo __('YouTube or Vimeo URL', 'compass'); ?>">
                        </div>
                    <?php endif; ?>

                    <?php if (get_option('cbn_enable_audio', 'on') === 'on') : ?>
                        <div class="media-upload cbn-audio-upload">
                            <label style="color: #e02aaf" for="cbn_location_audio"
                                   title="<?php echo __('Upload Audio', 'compass'); ?>">
                            ...
                            <input type="hidden" id="cbn_remove_existing_audio" name="cbn_remove_existing_audio"
                                   value="1"/>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($cbn_enable_user_notification) : ?>
                    <div>
                        <input class="cbn-switch" type="checkbox" id="cbn_location_notification"
                               name="cbn_location_notification">
                        <label for="cbn_location_notification"><?php echo $text_notify_me_on_publish_label; ?></label>
                    </div>
                    <div id="cbn_author">
                        <label for="cbn_location_author_name"></label><input type="text" id="cbn_location_author_name"
                                                                             name="cbn_location_author_name"
                                                                             placeholder="<?php echo $text_notify_me_on_publish_name; ?>*"/>
                        <label for="cbn_location_author_email"></label><input type="email"
                                                                              id="cbn_location_author_email"
                                                                              name="cbn_location_author_email"
                                                                              placeholder="<?php echo $text_notify_me_on_publish_email; ?>*"/>
                    </div>
                <?php endif; ?>

                <input type="submit" id="cbn_submit_btn" style="background-color: <?php echo $cbn_ui_color; ?>"
                       value="<?php echo get_option('cbn_submit_button_label') ? get_option('cbn_submit_button_label') : __('Submit location for review', 'compass'); ?>"/>
                <div id="cbn_delete_location_btn"><span
                            style="color: <?php echo $cbn_ui_color; ?>"><?php echo __('Delete this location', 'compass'); ?></span>
                </div>
            </form>
    ...
    <div id="location-fullscreen-container">
        ...
        <div id="close-location-fullscreen" onClick="cbnMap.closePopup()">✕</div>
    </div>
</div>