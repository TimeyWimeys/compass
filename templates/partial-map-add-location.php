    ...
    <div class="location-overlay-content">
      ...
      <form id="oum_add_location" enctype="multipart/form-data">
        ...
        <?php if(get_option('oum_enable_title', 'on')): ?>
          ...
          ?>
          <input type="text" id="oum_location_title" name="oum_location_title" <?php if(get_option('oum_title_required', 'on')): ?>required<?php endif; ?> placeholder="<?php echo $oum_title_label; ?><?php if(get_option('oum_title_required', 'on')): ?>*<?php endif; ?>" <?php echo $maxlength; ?> />
        <?php endif; ?>
          ...
          <?php if ( oum_fs()->can_use_premium_code() ): ?>
            ...
            <?php if(get_option('oum_enable_marker_types') && $types): ?>
              ...
              <?php if(get_option('oum_enable_multiple_marker_types')): ?>
                ...
                <fieldset id="oum_marker_icon">
                  ...
                  ?>
                    <div>
                      <label>
                        <input style="accent-color: <?php echo $oum_ui_color; ?>" type="checkbox" name="oum_marker_icon[]" value="<?php echo $tag->term_id; ?>">
              ...
              <?php else: ?>
                ...
                <select name="oum_marker_icon[]" id="oum_marker_icon">
        ...
        <?php if(is_array($oum_custom_fields)): ?>
          ...
          <?php foreach($oum_custom_fields as $index => $custom_field): ?>
            ...
            <?php if($custom_field['fieldtype'] == 'text'): ?>
              <div>
                <input type="text" name="oum_location_custom_fields[<?php echo $index; ?>]" placeholder="<?php echo $label; ?>" <?php echo (isset($custom_field['required']))? 'required' : ''; ?> value="" <?php echo $maxlength; ?> />
            ...
            <?php if($custom_field['fieldtype'] == 'link'): ?>
              <div>
                <input type="url" name="oum_location_custom_fields[<?php echo $index; ?>]" placeholder="<?php echo $label; ?>" <?php echo (isset($custom_field['required']))? 'required' : ''; ?> value="" <?php echo $maxlength; ?> />
                <?php echo $description; ?>
              </div>
            <?php endif; ?>
            ...
            <?php if($custom_field['fieldtype'] == 'email'): ?>
              <div>
                <input type="email" name="oum_location_custom_fields[<?php echo $index; ?>]" placeholder="<?php echo $label; ?>" <?php echo (isset($custom_field['required']))? 'required' : ''; ?> value="" <?php echo $maxlength; ?> />
                <?php echo $description; ?>
              </div>
            <?php endif; ?>
              ...
              <div>
                <fieldset class="<?php echo (isset($custom_field['required']))? 'is-required' : ''; ?>">
                  ...
                  ?>
                    <div>
                      <label>
                        <input style="accent-color: <?php echo $oum_ui_color; ?>" type="checkbox" name="oum_location_custom_fields[<?php echo $index; ?>][]" value="<?php echo esc_attr(trim($option)); ?>" <?php echo (isset($custom_field['required']))? 'required' : ''; ?>>
              ...
              <div>
                <fieldset class="<?php echo (isset($custom_field['required']))? 'is-required' : ''; ?>">
                  ...
                  ?>
                    <div>
                      <label>
                        <input style="accent-color: <?php echo $oum_ui_color; ?>" type="radio" name="oum_location_custom_fields[<?php echo $index; ?>]" value="<?php echo esc_attr(trim($option)); ?>" <?php echo (isset($custom_field['required']))? 'required' : ''; ?>>
                        <span><?php echo trim($option); ?></span>
                      </label>
                    </div>
                  <?php endforeach; ?>
        ...
        <?php if(get_option('oum_enable_address', 'on') === 'on'): ?>
          <input type="text" id="oum_location_address" name="oum_location_address" placeholder="<?php echo $oum_address_label; ?>" />
        <?php endif; ?>
        ...
        <?php if(get_option('oum_enable_image', 'on') === 'on' || get_option('oum_enable_audio', 'on') === 'on' || (oum_fs()->is__premium_only() && oum_fs()->can_use_premium_code() && get_option('oum_enable_video') === 'on')): ?>
          ...
          <?php if(get_option('oum_enable_image', 'on') === 'on'): ?>
            <div class="media-upload oum-image-upload">
              <div class="media-upload-top">
                <label for="oum_location_images" title="<?php echo __('Upload Images', 'open-user-map'); ?>">
            ...
            <?php if ( oum_fs()->can_use_premium_code() ): ?>
              <?php if(get_option('oum_enable_video') === 'on'): ?>
                <div class="media-upload oum-video-upload">
                  <label style="color: #e02aaf" for="oum_location_video" title="<?php echo __('YouTube or Vimeo Video', 'open-user-map'); ?>">
                    <span class="dashicons dashicons-format-video"></span>
                  </label>
                  <input type="text" id="oum_location_video" name="oum_location_video" placeholder="<?php echo __('YouTube or Vimeo URL', 'open-user-map'); ?>">
                </div>
              <?php endif; ?>
            <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if(get_option('oum_enable_audio', 'on') === 'on'): ?>
            <div class="media-upload oum-audio-upload">
              <label style="color: #e02aaf" for="oum_location_audio" title="<?php echo __('Upload Audio', 'open-user-map'); ?>">
        ...
        <?php if ( oum_fs()->is__premium_only() ): ?>
          <?php if ( oum_fs()->can_use_premium_code() ): ?>
            ...
            <?php if($oum_enable_user_notification): ?>
              <div>
                <input class="oum-switch" type="checkbox" id="oum_location_notification" name="oum_location_notification">
                <label for="oum_location_notification"><?php echo $text_notify_me_on_publish_label; ?></label>
              </div>
              <div id="oum_author">
                <input type="text" id="oum_location_author_name" name="oum_location_author_name" placeholder="<?php echo $text_notify_me_on_publish_name; ?>*" />
                <input type="email" id="oum_location_author_email" name="oum_location_author_email" placeholder="<?php echo $text_notify_me_on_publish_email; ?>*" />
              </div>
            <?php endif; ?>
        ...
        <input type="submit" id="oum_submit_btn" style="background-color: <?php echo $oum_ui_color; ?>" value="<?php echo get_option('oum_submit_button_label') ? get_option('oum_submit_button_label') : __('Submit location for review', 'open-user-map'); ?>" />
