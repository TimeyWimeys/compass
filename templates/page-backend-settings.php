          ...
          <table class="form-table">
              ...
              <td class="top-padding-20">
                ...
                <div class="oum-shortcode-docs">
                    ...
                    <div class="oum-examples">
                        <p><strong><?php echo __('Example 1: Map of London with food locations only', 'open-user-map'); ?></strong></p>
                        <code>[open-user-map lat="51.50665" long="-0.12752" zoom="13" types="food" size="fullwidth" height="500px"]</code>
                        
                        <p><strong><?php echo __('Example 2: Simple map showing only locations from the current user', 'open-user-map'); ?></strong> <span class="oum-pro">PRO</span></p>
                        <code>[open-user-map map_type="simple" user="current" enable_fullscreen="true" enable_searchbar="false"]</code>
                        
                        <p><strong><?php echo __('Example 3: Interactive map for a specific region with custom appearance', 'open-user-map'); ?></strong></p>
            ...
            <tr valign="top">
              ...
              <td class="top-padding-20">
                ...
                <ul>
                  <li><code>url="https://mysite.com/"</code> - <?php echo __('Link the images to another page.', 'open-user-map'); ?></li>
                  <li><code>number="10"</code> - <?php echo __('Limit the number of images displayed.', 'open-user-map'); ?></li>
                  <li><code>user="current"</code> - <?php echo __('Filter images by user. Accepts "current", a user ID, or "role:rolename".', 'open-user-map'); ?></li>
                </ul>
                <br><br>
                ...
                <strong><?php echo __('Available attributes:', 'open-user-map'); ?></strong>
                <ul>
                  <li><code>user="current"</code> - <?php echo __('Filter locations by user. Accepts "current", a user ID, or "role:rolename".', 'open-user-map'); ?></li>
                  <li><code>types="food|drinks"</code> - <?php echo __('Filter by marker categories. Separate multiple types with a | symbol.', 'open-user-map'); ?></li>
                  <li><code>ids="123|456"</code> - <?php echo __('Filter by location IDs. Separate multiple IDs with a | symbol.', 'open-user-map'); ?></li>
                </ul>
                <br><br>
              </td>
            </tr>
