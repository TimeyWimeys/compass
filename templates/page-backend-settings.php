...
<form method="post" action="options.php">
    ...
    <?php if(get_option('oum_enable_add_location') !== 'on' && get_option('oum_enable_add_location') !== ''): ?>
      ...
      <?php settings_fields('compass-settings-group-wizard-1');?>
      <?php do_settings_sections('compass-settings-group-wizard-1');?>
      ...
      <div class="oum-wizard">
        ...
        <div class="step-content">
          <div class="intro">
            <?php echo __('Use Open User Map to create either an interactive map that lets visitors add location markers or a custom map featuring your own locations.', 'compass'); ?><br><br>
    ...
    <?php elseif(get_option('oum_wizard_usecase_done') && !get_option( 'oum_wizard_finish_done' )): ?>
      ...
      <?php settings_fields('compass-settings-group-wizard-2');?>
      <?php do_settings_sections('compass-settings-group-wizard-2');?>
      ...
      <div class="oum-wizard">
        ...
        <div class="step-content">
          ...
          <?php if(get_option('oum_wizard_usecase') == '1'): ?>
            ...
            <ol class="next-steps">
              <li><?php echo __('Use the page editor or Elementor to insert the <b>"Open User Map"</b> block onto a page.<br>Alternatively, you can use the shortcode <code>[compass]</code>.', 'compass'); ?></li>
              <li><?php echo __('Your website visitors will see a <div class="oum-inline-plus">+</div> button in the upper right corner of the map, which they can use to propose their own location markers. New location proposals will have status "pending" to wait for your approval in the <i>Open User Map > All Locations</i> menu.', 'compass'); ?></li>
              <li><?php echo __('Customize styles, activate features and find help under <i>Open User Map > Settings</i>', 'compass'); ?></li>
            </ol>

          <?php elseif(get_option('oum_wizard_usecase') == '2'): ?>

            <ol class="next-steps">
              <li><?php echo sprintf( __('Add your first Location under <a href="%s">Open User Map > Add Location</a>', 'compass'), 'post-new.php?post_type=oum-location'); ?></li>
              <li><?php echo __('Use the page editor or Elementor to insert the <b>"Open User Map"</b> block onto a page.<br>Alternatively, you can use the shortcode <code>[compass]</code>.', 'compass'); ?></li>
              <li><?php echo __('Customize styles, activate features and find help under <i>Open User Map > Settings</i>', 'compass'); ?></li>
            </ol>
          ...
          <table class="form-table">
                ...
                <div class="map-types">
                  <div class="option">
                      <label>
                        <div class="map-type-preview" data-type="interactive"></div>
                        <div class="label-text">
                          <input type='radio' name='oum_map_type' value='1' <?php echo ($oum_enable_add_location == 'on') ? 'checked' : ''; ?>>
                          <h2><?php echo __('Interactive Map', 'compass'); ?></h2>
                          <p><?php echo __('Create a community map! Visitors to your page can add new location markers to the map. You will receive a notification to approve each location before it is published.', 'compass'); ?></p>
                          <div id="plus_button_label">
                            <strong><?php echo __('Custom "+" Button Label:', 'compass'); ?></strong><br>
                            <input class="regular-text" type="text" name="oum_plus_button_label" id="oum_plus_button_label" placeholder="<?php echo __('Add location', 'compass'); ?>" value="<?php echo esc_textarea($oum_plus_button_label); ?>">
                          </div>
                        </div>
                      </label>
                    </div>
                    <div class="option">
                      <label>
                        <div class="map-type-preview" data-type="simple"></div>
                        <div class="label-text">
                          <input type='radio' name='oum_map_type' value='2' <?php echo ($oum_enable_add_location != 'on') ? 'checked' : ''; ?>>
                          <h2><?php echo __('Simple Map', 'compass'); ?></h2>
                          ...
                          <br>
                          <p><?php echo __('<a href="edit.php?post_type=oum-location">Manage all Locations here</a>', 'compass'); ?></p>
                        </div>
                      </label>
                    </div>
                </div>

                <input type="checkbox" id="oum_enable_add_location" name="oum_enable_add_location" <?php echo ($oum_enable_add_location == 'on') ? 'checked' : ''; ?>>
              ...
              <td>
                ...
                <div class="wrap-tile-provider-settings">
                  ...
                  <div class="tile-provider-mapbox">
                    ...
                    <input class="regular-text" type="text" name="oum_tile_provider_mapbox_key" id="oum_tile_provider_mapbox_key" value="<?php echo esc_attr($oum_tile_provider_mapbox_key); ?>">
                    <br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <div class="marker_icons">
                      ...
                      foreach($pro_items as $val) {
                        ...
                        echo "
                          <div class='icon_upload'>
                            <a href='#' class='oum_upload_icon_button button button-secondary'>" . __('Upload Icon', 'compass') . "</a>
                  ...
                  <td>
                    <div id="oum_ui_color_wrap">
                      <input type="text" class="oum_colorpicker" name="oum_ui_color" value="<?php echo esc_attr($oum_ui_color); ?>" placeholder="<?php echo esc_attr($oum_ui_color); ?>">
                    </div>
                  </td>
                </tr>
                ...
                <td>
                  <div id="oum_ui_color_wrap">
                    <input disabled type="text" class="oum_colorpicker" value="<?php echo esc_attr($oum_ui_color); ?>" placeholder="<?php echo esc_attr($oum_ui_color); ?>">
                  </div>
                </td>
              </tr>
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                <input class="regular-text" type="text" name="oum_map_height" id="oum_map_height" placeholder="e.g. 400px" value="<?php echo esc_attr($oum_map_height); ?>"><br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                ?>
                <strong><?php echo __('Custom Height:', 'compass'); ?></strong><br>
                <input class="regular-text" type="text" name="oum_map_height_mobile" id="oum_map_height_mobile" placeholder="e.g. 400px" value="<?php echo esc_attr($oum_map_height_mobile); ?>"><br><br>
                <div class="description"><?php echo __('Don\'t forget to add a unit like <b>px</b>.', 'compass'); ?></div>
              </td>
            </tr>
                    ...
                    <div class="input-wrap">
                        <div class="latlng-wrap">
                            <div class="form-field lat-wrap">
                                ...
                                <input type="text" readonly class="widefat" id="oum_start_lat" name="oum_start_lat" value="<?php echo esc_attr($start_lat); ?>">
                            </div>
                            <div class="form-field lng-wrap">
                                <label class="meta-label" for="oum_start_lng">
                                    <?php echo __('Lng', 'compass'); ?>
                                </label>
                                <input type="text" readonly class="widefat" id="oum_start_lng" name="oum_start_lng" value="<?php echo esc_attr($start_lng); ?>">
                            </div>
                            <div class="form-field zoom-wrap">
                                <label class="meta-label" for="oum_start_zoom">
                                    <?php echo __('Zoom', 'compass'); ?>
                                </label>
                                <input type="text" readonly class="widefat" id="oum_start_zoom" name="oum_start_zoom" value="<?php echo esc_attr($start_zoom) ? esc_attr($start_zoom) : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="additional-map-settings">
                          ...
                          <input class="oum-switch" type="checkbox" id="oum_enable_fixed_map_bounds" name="oum_enable_fixed_map_bounds" <?php echo ($oum_enable_fixed_map_bounds == 'on') ? 'checked' : ''; ?>>
                          <label for="oum_enable_fixed_map_bounds"><?php echo __('Keep map focus in fixed position', 'compass'); ?></label><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" name="oum_enable_cluster" id="oum_enable_cluster" <?php echo ($oum_enable_cluster === 'on')? 'checked' : ''; ?>>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" name="oum_enable_scrollwheel_zoom_map" id="oum_enable_scrollwheel_zoom_map" <?php echo ($oum_enable_scrollwheel_zoom_map === 'on')? 'checked' : ''; ?>>
                  ...
                  <td>
                    ...
                    <div class="wrap-geosearch-provider-settings">
                      <div class="geosearch-provider-geoapify">
                        ...
                        <input class="regular-text" type="text" name="oum_geosearch_provider_geoapify_key" id="oum_geosearch_provider_geoapify_key" value="<?php echo esc_attr($oum_geosearch_provider_geoapify_key); ?>">
                        <br><br>
                      ...
                      <div class="geosearch-provider-here">
                        ...
                        <input class="regular-text" type="text" name="oum_geosearch_provider_here_key" id="oum_geosearch_provider_here_key" value="<?php echo esc_attr($oum_geosearch_provider_here_key); ?>">
                        <br><br>
                      ...
                      <div class="geosearch-provider-mapbox">
                        <strong><?php echo __('MapBox API Key:', 'compass'); ?></strong><br>
                        <input class="regular-text" type="text" name="oum_geosearch_provider_mapbox_key" id="oum_geosearch_provider_mapbox_key" value="<?php echo esc_attr($oum_geosearch_provider_mapbox_key); ?>">
                        <br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" name="oum_enable_fullscreen" id="oum_enable_fullscreen" <?php echo ($oum_enable_fullscreen === 'on')? 'checked' : ''; ?>>
                ...
                <td>
                  ...
                  <td>
                    <input class="oum-switch" type="checkbox" name="oum_disable_oum_attribution" id="oum_disable_oum_attribution" <?php echo ($oum_disable_oum_attribution)? 'checked' : ''; ?>>
        ...
        <div id="tab-2" class="tab-pane">
          ...
          <table class="form-table">
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="regular-text" type="text" name="oum_form_headline" id="oum_form_headline" placeholder="<?php echo __('Add a new location', 'compass'); ?>" value="<?php echo esc_textarea($oum_form_headline); ?>"><br>
              </td>
            </tr>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <div class="oum_2cols">
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_enable_title" id="oum_enable_title" <?php echo ($oum_enable_title == 'on')? 'checked' : ''; ?>>
                    <label for="oum_enable_title"><?php echo __('Enable', 'compass'); ?></label>
                  </div>
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_title_required" id="oum_title_required" <?php echo ($oum_title_required)? 'checked' : ''; ?>>
                    <label for="oum_title_required"><?php echo __('Required', 'compass'); ?></label>
                  </div>
                  <div>
                    <input class="small-text oum_title_maxlength" type="number" min="0" name="oum_title_maxlength" id="oum_title_maxlength" value="<?php echo isset($oum_title_maxlength) ? esc_attr($oum_title_maxlength) : ''; ?>" />
                    <label for="oum_title_maxlength"><?php echo __('Max. length', 'compass'); ?></label>
                  </div>
                </div>
                <br>
                  ...
                  <table>
                    ...
                    <?php if(is_array($oum_custom_fields)): ?>
                      <?php foreach($oum_custom_fields as $index => $custom_field): ?>
                        <tr>
                          <td>
                            <input type="text" class="field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" name="oum_custom_fields[<?php echo $index; ?>][label]" placeholder="<?php echo __('Enter label', 'compass'); ?>" value="<?php echo esc_attr($custom_field['label']); ?>" />
                          </td>
                          <td>
                            <input class="oum-switch field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" id="oum_custom_fields_<?php echo $index; ?>_required" type="checkbox" name="oum_custom_fields[<?php echo $index; ?>][required]" <?php echo (isset($custom_field['required']))? 'checked' : '';?> /><label class="field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" for="oum_custom_fields_<?php echo $index; ?>_required"></label>
                          </td>
                          <td>
                            <input class="oum-switch field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" id="oum_custom_fields_<?php echo $index; ?>_private" type="checkbox" name="oum_custom_fields[<?php echo $index; ?>][private]" <?php echo (isset($custom_field['private']))? 'checked' : '';?> /><label class="field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" for="oum_custom_fields_<?php echo $index; ?>_private"></label>
                          </td>
                          <td>
                            <input class="small-text field-type-text field-type-link field-type-email" type="number" min="0" name="oum_custom_fields[<?php echo $index; ?>][maxlength]" value="<?php echo isset($custom_field['maxlength']) ? esc_attr($custom_field['maxlength']) : ''; ?>" />
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <label class="field-type-select oum-custom-field-allow-empty"><input class="field-type-select" type="checkbox" name="oum_custom_fields[<?php echo $index; ?>][emptyoption]" <?php echo isset($custom_field['emptyoption']) ? 'checked' : ''; ?> ><?php echo __('add empty option', 'compass'); ?></label>
                            <label class="field-type-link oum-custom-field-use-label-as-text"><input class="field-type-link" type="checkbox" name="oum_custom_fields[<?php echo $index; ?>][uselabelastextoption]" <?php echo isset($custom_field['uselabelastextoption']) ? 'checked' : ''; ?> ><?php echo __('use label as text', 'compass'); ?></label>
                          ...
                          <td>
                            <input type="text" class="field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" name="oum_custom_fields[<?php echo $index; ?>][description]" placeholder="<?php echo __('Enter description (optional)', 'compass'); ?>" value="<?php echo isset($custom_field['description']) ? esc_textarea($custom_field['description']) : ''; ?>" />
                          </td>
                          <td class="actions">
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" name="oum_enable_address" id="oum_enable_address" <?php echo ($oum_enable_address === 'on')? 'checked' : ''; ?>>
                <label for="oum_enable_address"><?php echo __('Enable', 'compass'); ?></label><br>

                <input class="oum-switch" type="checkbox" name="oum_hide_address" id="oum_hide_address" <?php echo ($oum_hide_address)? 'checked' : ''; ?>>
                <label for="oum_hide_address"><?php echo __('Don\'t show inside Location Pop-Up', 'compass'); ?></label><br>
                
                <input class="oum-switch" type="checkbox" name="oum_enable_gmaps_link" id="oum_enable_gmaps_link" <?php echo ($oum_enable_gmaps_link === 'on')? 'checked' : ''; ?>>
                <label for="oum_enable_gmaps_link"><?php echo __('Link to Google Maps', 'compass'); ?></label><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <div class="oum_2cols">
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_enable_description" id="oum_enable_description" <?php echo ($oum_enable_description === 'on')? 'checked' : ''; ?>>
                    <label for="oum_enable_description"><?php echo __('Enable', 'compass'); ?></label>
                  </div>
                  <div>
                    ...
                    <label for="oum_description_required"><?php echo __('Required', 'compass'); ?></label>
                  </div>
                </div>
                <br>
                <strong><?php echo __('Custom Label:', 'compass'); ?></strong><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                <div class="oum_2cols">
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_enable_image" id="oum_enable_image" <?php echo ($oum_enable_image === 'on')? 'checked' : ''; ?>>
                    <label for="oum_enable_image"><?php echo __('Image', 'compass'); ?></label>
                  </div>
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_image_required" id="oum_image_required" <?php echo ($oum_image_required)? 'checked' : ''; ?>>
                    <label for="oum_image_required"><?php echo __('Required', 'compass'); ?></label>
                  </div>
                </div>
                <br><br>
                    <div class="oum_2cols">
                      <div>
                        <input class="oum-switch" type="checkbox" name="oum_enable_video" id="oum_enable_video" <?php echo ($oum_enable_video === 'on')? 'checked' : ''; ?>>
                        <label for="oum_enable_video"><?php echo __('Video (YouTube, Vimeo)', 'compass'); ?></label>
                      </div>
                      <div>
                        <input class="oum-switch" type="checkbox" name="oum_video_required" id="oum_video_required" <?php echo ($oum_video_required)? 'checked' : ''; ?>>
                        <label for="oum_video_required"><?php echo __('Required', 'compass'); ?></label>
                      </div>
                      <div>
                ...
                <div class="oum_2cols">
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_enable_audio" id="oum_enable_audio" <?php echo ($oum_enable_audio === 'on')? 'checked' : ''; ?>>
                    <label for="oum_enable_audio"><?php echo __('Audio', 'compass'); ?></label>
                  </div>
                  <div>
                    <input class="oum-switch" type="checkbox" name="oum_audio_required" id="oum_audio_required" <?php echo ($oum_audio_required)? 'checked' : ''; ?>>
                    <label for="oum_audio_required"><?php echo __('Required', 'compass'); ?></label>
                  </div>
                </div>
                <br><br>

                <strong><?php echo __('Custom Label:', 'compass'); ?></strong><br>
                <input class="regular-text" type="text" name="oum_upload_media_label" id="oum_upload_media_label" placeholder="<?php echo esc_attr($this->oum_upload_media_label_default); ?>" value="<?php echo esc_attr($oum_upload_media_label); ?>">
                <br><br>
              </td>
            </tr>
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    <div class="oum_2cols">
                      <div>
                        ...
                        <input class="small-text" type="number" min="1" name="oum_max_image_filesize" id="oum_max_image_filesize" value="<?php echo esc_attr($oum_max_image_filesize); ?>">MB
                      </div>
                      <div>
                        <strong><?php echo __('Audio'); ?>:</strong><br>
                        <input class="small-text" type="number" min="1" name="oum_max_audio_filesize" id="oum_max_audio_filesize" value="<?php echo esc_attr($oum_max_audio_filesize); ?>">MB
                      </div>
                    </div>
                    <br><br>
                  </td>
              ...
              <tr style="vertical-align: top;"> class="oum-gopro-tr">
                ...
                <td>
                  <div class="oum_2cols">
                    <div>
                      <strong><?php echo __('Image'); ?>:</strong><br>
                      <input disabled class="small-text" type="number" min="1" value="10">MB
                    </div>
                    <div>
                      <strong><?php echo __('Audio'); ?>:</strong><br>
                      <input disabled class="small-text" type="number" min="1" value="10">MB
                ...
                <tr style="vertical-align: top;">>
                  ...
                  $oum_user_notification_subject = get_option('oum_user_notification_subject') ? get_option('oum_user_notification_subject') : __('Your location has been approved', 'compass');
                  $oum_user_notification_message = get_option('oum_user_notification_message') ? get_option('oum_user_notification_message') : __('Hey %name%! Your location proposal on %website_url% has been published!', 'compass');
                  ?>
                  <th scope="row">
                  ...
                  <td>
                    ...
                    <strong><?php echo __('Custom Label:', 'compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="oum_user_notification_label" id="oum_user_notification_label" placeholder="<?php echo esc_attr($this->oum_user_notification_label_default); ?>" value="<?php echo esc_textarea($oum_user_notification_label); ?>">
                    <br><br>
                    
                    <strong><?php echo __('Subject'); ?>:</strong><br>
                    <input class="regular-text" type="text" name="oum_user_notification_subject" id="oum_user_notification_subject" value="<?php echo esc_textarea($oum_user_notification_subject); ?>"><br><br>

                    <strong><?php echo __('Message'); ?>:</strong><br>
                    <textarea class="regular-text" name="oum_user_notification_message" id="oum_user_notification_message" rows="8" cols="50"><?php echo esc_textarea($oum_user_notification_message); ?></textarea><br>
              ...
              <tr style="vertical-align: top;"> class="oum-gopro-tr">
                ...
                <td>
                  ...
                  <strong><?php echo __('Subject'); ?>:</strong><br>
                  <input disabled class="regular-text" type="text" placeholder="<?php echo __('Your location has been approved', 'compass'); ?>"><br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="regular-text" type="text" name="oum_submit_button_label" id="oum_submit_button_label" placeholder="<?php echo __('Submit location for review', 'compass'); ?>" value="<?php echo esc_textarea($oum_submit_button_label); ?>"><br>
              </td>
            </tr>
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                <div id="oum_action_after_submit_text">
                  ...
                  ?>
                  <input class="regular-text" type="text" name="oum_thankyou_headline" id="oum_thankyou_headline" placeholder="<?php echo __('Thank you!', 'compass'); ?>" value="<?php echo esc_textarea($oum_thankyou_headline); ?>"><br><br>
                  <textarea class="regular-text" name="oum_thankyou_text" id="oum_thankyou_text" rows="4" cols="50" placeholder="<?php echo __('We will check your location suggestion and release it as soon as possible.', 'compass'); ?>"><?php echo esc_textarea($oum_thankyou_text); ?></textarea><br><br>
                </div>
                <div id="oum_action_after_submit_redirect">
                  <?php
                  $oum_thankyou_redirect = get_option('oum_thankyou_redirect');
                  ?>
                  <input class="regular-text" type="text" name="oum_thankyou_redirect" id="oum_thankyou_redirect" placeholder="<?php echo 'https://loremipsum.com'; ?>" value="<?php echo esc_textarea($oum_thankyou_redirect); ?>">
                </div>
              </td>
            </tr>
          ...
          <table class="form-table">
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    ...
                    ?>
                    <input class="oum-switch" type="checkbox" name="oum_enable_searchbar" id="oum_enable_searchbar" <?php echo ($oum_enable_searchbar === 'on')? 'checked' : ''; ?>>
                    ...
                    <div class="wrap-searchbar-settings">
                      ...
                      <div id="oum_searchbar_type_options">
                          ...
                          ?>
                              <label>
                                  <input type="radio" name="oum_searchbar_type" value="<?php echo esc_attr($val); ?>" <?php echo $checked; ?>>
                                  <strong><?php  echo esc_html($label); ?></strong><?php echo ($val === 'live_filter') ? '&nbsp;&nbsp;<span class="oum-pro">PRO</span>' : ''; ?><br>
                                  <?php if ($val === 'address'): ?>
                    ...
                    <div class="wrap-searchbar-settings">
                      ...
                      <div id="oum_searchbar_type_options">
                          ...
                          <label class="oum-gopro-div">
                            ...
                            <strong><?php  echo __('Live Filter Markers', 'compass'); ?></strong>&nbsp;&nbsp;<span class="oum-pro">PRO</span><br>
                            <small><?php echo __('Filter markers live as you type to instantly refine the map view.', 'compass'); ?></small>
                          </label>
                      </div>
                    </div>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                ?>
                <input class="oum-switch" type="checkbox" name="oum_enable_searchaddress_button" id="oum_enable_searchaddress_button" <?php echo ($oum_enable_searchaddress_button === 'on')? 'checked' : ''; ?>>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                ...
                ?>
                <input class="oum-switch" type="checkbox" name="oum_enable_searchmarkers_button" id="oum_enable_searchmarkers_button" <?php echo ($oum_enable_searchmarkers_button === 'on')? 'checked' : ''; ?>>
                <label for="oum_enable_searchmarkers_button"></label><br><br>
                <strong><?php echo __('Custom Label:', 'compass'); ?></strong><br>
                <input class="regular-text" type="text" name="oum_searchmarkers_label" id="oum_searchmarkers_label" placeholder="<?php echo esc_attr($this->oum_searchmarkers_label_default); ?>" value="<?php echo esc_attr($oum_searchmarkers_label); ?>"><br><br>
                <strong><?php echo __('Zoom level:', 'compass'); ?></strong><br>
                <input class="small-text" type="number" min="1" max="19" name="oum_searchmarkers_zoom" id="oum_searchmarkers_zoom" placeholder="<?php echo esc_attr($this->oum_searchmarkers_zoom_default); ?>" value="<?php echo esc_attr($oum_searchmarkers_zoom); ?>"><br><br>
                ...
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    ...
                    <label for="oum_enable_marker_types"><?php echo __('Enable', 'compass'); ?></label><br>
                    <?php if($oum_enable_marker_types): ?>
                      <div class="description"><?php echo __('You can manage Marker Categories <a href="edit-tags.php?taxonomy=oum-type&post_type=oum-location">here</a>', 'compass'); ?></div>
                      <br>
                    <?php endif; ?>
                    <br>
                    ...
                    <div class="wrap-marker-categories-settings">
                      ...
                      <input class="oum-switch" type="checkbox" name="oum_enable_multiple_marker_types" id="oum_enable_multiple_marker_types" <?php echo ($oum_enable_multiple_marker_types)? 'checked' : ''; ?>>
                      <label for="oum_enable_multiple_marker_types"><?php echo __('Allow multiple selections', 'compass'); ?></label><br>
                      <div class="description"><?php echo __('<strong>Important:</strong> If enabled all locations will fallback to the <a href="edit.php?post_type=oum-location&page=compass-settings">Default Marker Icon</a> instead of a specific category icon.', 'compass'); ?></div>
                      <br><br><br>

                      <input class="oum-switch" type="checkbox" name="oum_enable_empty_marker_type" id="oum_enable_empty_marker_type" <?php echo ($oum_enable_empty_marker_type)? 'checked' : ''; ?>>
                      <label for="oum_enable_empty_marker_type"><?php echo __('Allow empty selection', 'compass'); ?></label>
                      <br><br><br>

                      <input class="oum-switch" type="checkbox" name="oum_collapse_filter" id="oum_collapse_filter" <?php echo ($oum_collapse_filter)? 'checked' : ''; ?>>
                      <label for="oum_collapse_filter"><?php echo __('Collapsed Filterbox', 'compass'); ?></label><br>
        ...
        <div id="tab-4" class="tab-pane">
          <table class="form-table">
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" name="oum_enable_regions" id="oum_enable_regions" <?php echo ($oum_enable_regions)? 'checked' : ''; ?>>
                <label for="oum_enable_regions"></label><br><br>

                <?php if($oum_enable_regions): ?>
                  <div class="description"><?php echo __('You can manage Regions <a href="edit-tags.php?taxonomy=oum-region&post_type=oum-location">here</a>', 'compass'); ?></div>
                  <br>
                <?php endif; ?>
              </td>
            </tr>
        ...
        <div id="tab-5" class="tab-pane">
          ...
          <table class="form-table">
            ...
            <tr style="vertical-align: top;">>
              ...
              <td>
                <input class="oum-switch" type="checkbox" id="oum_enable_location_date" name="oum_enable_location_date" <?php echo ($oum_enable_location_date == 'on') ? 'checked' : ''; ?>>
              ...
              <tr style="vertical-align: top;"> class="oum-gopro-tr">
                ...
                <tr style="vertical-align: top;">>
                  ...
                  $oum_admin_notification_subject = get_option('oum_admin_notification_subject') ? get_option('oum_admin_notification_subject') : __('New Open User Map location', 'compass');
                  $oum_admin_notification_message = get_option('oum_admin_notification_message') ? get_option('oum_admin_notification_message') : __('A new location with the title "%title%" on %website_url% has been added! Please verify and publish or use the "auto-publish" feature.', 'compass');
                  ?>
                  <th scope="row">
                  ...
                  <td>
                    ...
                    <input class="regular-text" type="text" name="oum_admin_notification_email" id="oum_admin_notification_email" value="<?php echo esc_textarea($oum_admin_notification_email); ?>"><br><br>

                    <strong><?php echo __('Subject'); ?>:</strong><br>
                    <input class="regular-text" type="text" name="oum_admin_notification_subject" id="oum_admin_notification_subject" value="<?php echo esc_textarea($oum_admin_notification_subject); ?>"><br><br>

                    <strong><?php echo __('Message'); ?>:</strong><br>
                    <textarea class="regular-text" name="oum_admin_notification_message" id="oum_admin_notification_message" rows="8" cols="50"><?php echo esc_textarea($oum_admin_notification_message); ?></textarea><br>
              ...
              <tr style="vertical-align: top;"> class="oum-gopro-tr">
                ...
                <td>
                  ...
                  <strong><?php echo __('Email address'); ?>:</strong><br>
                  <input disabled class="regular-text" type="text" placeholder="<?php echo __('john@doe.com', 'compass'); ?>"><br><br>
                  
                  <strong><?php echo __('Subject'); ?>:</strong><br>
                  <input disabled class="regular-text" type="text" placeholder="<?php echo __('New Open User Map location', 'compass'); ?>"><br><br>
                ...
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    <input class="oum-switch" type="checkbox" id="oum_enable_webhook_notification" name="oum_enable_webhook_notification" <?php echo ($oum_enable_webhook_notification == 'on') ? 'checked' : ''; ?>>
                    <label for="oum_enable_webhook_notification"></label><br><br>
                    
                    <strong><?php echo __('Webhook URL'); ?>:</strong><br>
                    <input class="regular-text" type="text" name="oum_webhook_notification_url" id="oum_webhook_notification_url" value="<?php echo esc_url($oum_webhook_notification_url); ?>">
            ...
            <tr style="vertical-align: top;"> >
                ...
                <td>
                  ...
                  <textarea class="regular-text" name="oum_custom_js" id="oum_custom_js" rows="8" cols="50" placeholder="<?php echo __("e.g. console.log('The map is ready')", "compass"); ?>"><?php echo $oum_custom_js; ?></textarea><br><br>
        ...
        <div id="tab-6" class="tab-pane">
          ...
          <table class="form-table">
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    <button class="oum_export_csv_button button button-secondary"><?php echo __('Export to CSV', 'compass'); ?></button>
                    <br><br>
                ...
                <tr style="vertical-align: top;">>
                  ...
                  <td>
                    <div class="csv_upload">
                      <button class="oum_upload_csv_button button button-secondary"><?php echo __('Upload CSV & Import', 'compass'); ?></button>
                      <br><br>
                      <div class="description">
          ...
          <table class="form-table">
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                <?php echo sprintf( __( '<ol><li>Use the page editor or Elementor to insert the <b>"Open User Map"</b> block onto a page. Alternatively, you can use the shortcode <code>[compass]</code></li><li>You can <a href="%s">manage Locations</a> under <i>Open User Map > All Locations</i></li><li><a href="%s">Customize</a> styles and features under <i>Open User Map > Settings</i></li></ol>', 'compass' ), 'edit.php?post_type=oum-location', 'edit.php?post_type=oum-location&page=compass-settings' ); ?>
              </td>
            </tr>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                <?php echo  __( 'Use the "Open User Map" block to integrate the map inside your page. <br>You can set custom map position and filter for categories and locations inside the block settings.', 'compass' ) ;?>
              </td>
            </tr>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                <?php echo  __( 'Use the Elementor Widget "Open User Map" to integrate the map inside your page. <br>You can set custom map position and filter for categories and locations inside the widget settings.', 'compass' ) ;?>
              </td>
            </tr>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                ...
                <p class="hint"><?php echo __('You can use shortcode attributes to override the <a href="edit.php?post_type=oum-location&page=compass-settings">global settings</a>. This allows for custom individual maps.', 'compass'); ?></p><br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                <span class="oum-pro">PRO</span> <code>[compass-location value="Favorite color" post_id="12345"]</code> 
                <br><br>
                <span class="hint"><?php echo __('Display specific values from a location. The POST_ID attribute is optional. Alternatively use the PHP function <code>oum_get_location_value( $value, $post_id )</code> in case you just want to return the value.', 'compass'); ?></span>
                <br><br>
                ...
                <br><br><br>
                <span class="oum-pro">PRO</span> <code>[compass-gallery url="https://mysite.com/" number="10"]</code> 
                <br><br>
                ...
                <br><br><br>
                <span class="oum-pro">PRO</span> <code>[compass-list]</code> 
                <br><br>
            ...
            <tr style="vertical-align: top;">>
              ...
              <td class="top-padding-20">
                <span class="hint"><?php echo __('Make use of filter hooks to extend the functionality of the Open User Map plugin.', 'compass'); ?> <?php echo __('Find more info on how to use hooks <a href="https://www.compass.com/knowledge-base/change-or-extend-content-of-each-location-bubble/?ref=pluginsettings">here</a>.', 'compass'); ?></span><br><br>
  ...
  return $content;
                ...
                <br><br><br>
                <span class="oum-pro">PRO</span> <strong><?php echo __('Customize location list item content:', 'compass'); ?></strong><br><br>
