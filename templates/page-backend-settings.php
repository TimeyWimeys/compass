					...
					<tr style="vertical-align: top;">
						...
						<td>
							<div class="map_styles">
								...
								$items     = isset( $this->map_styles ) && is_array( $this->map_styles ) ? $this->map_styles : array();
								...
								$custom_items = isset( $this->custom_map_styles ) && is_array( $this->custom_map_styles ) ? $this->custom_map_styles : array();
								...
								$commercial_items = isset( $this->commercial_map_styles ) && is_array( $this->commercial_map_styles ) ? $this->commercial_map_styles : array();
					...
					<tr style="vertical-align: top;">
						...
						<td>
							<div class="marker_icons">
								...
								$items = array_merge( $this->marker_icons ?? array(), $this->pro_marker_icons ?? array() );
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<select name="cbn_map_size" id="cbn_map_size">
								...
								$items          = isset( $this->cbn_map_sizes ) && is_array( $this->cbn_map_sizes ) ? $this->cbn_map_sizes : array();
						...
						<td>
							<label for="cbn_geosearch_provider"><?php echo __( 'cbn_geosearch_provider', 'compass' ); ?></label><select
								...
								if ( ! isset( $this->cbn_geosearch_provider ) || ! is_array( $this->cbn_geosearch_provider ) ) {
									...
									$this->cbn_geosearch_provider = array();
								}
				...
				<table class="form-table">
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<br>
							<strong><?php echo __( 'Custom Label:', 'compass' ); ?></strong><br>
							<input class="regular-text" type="text" name="cbn_description_label"
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<br><br>
							<strong><?php echo __( 'Custom Label:', 'compass' ); ?></strong><br>
							<input class="regular-text" type="text" name="cbn_upload_media_label"
					...
					<tr style="vertical-align: top;">
						...
						<td>
							<input class="regular-text" type="text" name="cbn_submit_button_label"
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<div id="cbn_action_after_submit_text">
								...
								?>
								<input class="regular-text" type="text" name="cbn_thankyou_headline"
							...
							<div id="cbn_action_after_submit_redirect">
								...
								?>
								<input class="regular-text" type="text" name="cbn_thankyou_redirect"
				...
				<table class="form-table">
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<strong><?php echo __( 'Custom Label:', 'compass' ); ?></strong><br>
							<input class="regular-text" type="text" name="cbn_searchaddress_label"
					...
					<tr style="vertical-align: top;">
						...
						<td>
							...
							<strong><?php echo __( 'Custom Label:', 'compass' ); ?></strong><br>
							<input class="regular-text" type="text" name="cbn_searchmarkers_label"
