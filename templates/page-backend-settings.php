...
<form method="post" action="options.php">
    ...
    <?php if(get_option('oum_enable_add_location') !== 'on' && get_option('oum_enable_add_location') !== ''): ?>
      ...
      <div class="oum-wizard">
        ...
        <div class="step-content">
          <div class="intro">
            <?php echo __('Use Open User Map to create either an interactive map that lets visitors add location markers or a custom map featuring your own locations.', 'open-user-map'); ?><br><br>
                      ...
                      <label>
                        ...
                        <div class="label-text">
                          ...
                          <div id="plus_button_label">
                            ...
                            <input class="regular-text" type="text" name="oum_plus_button_label" id="oum_plus_button_label" placeholder="<?php echo __('Add location', 'open-user-map'); ?>" value="<?php echo esc_textarea($oum_plus_button_label); ?>"></input>
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div class="input-wrap">
                        <div class="latlng-wrap">
                            <div class="form-field lat-wrap">
                                ...
                                <input type="text" readonly class="widefat" id="oum_start_lat" name="oum_start_lat" value="<?php echo esc_attr($start_lat); ?>"></input>
                            </div>
                            <div class="form-field lng-wrap">
                                <label class="meta-label" for="oum_start_lng">
                                    <?php echo __('Lng', 'open-user-map'); ?>
                                </label>
                                <input type="text" readonly class="widefat" id="oum_start_lng" name="oum_start_lng" value="<?php echo esc_attr($start_lng); ?>"></input>
                            </div>
                            <div class="form-field zoom-wrap">
                                <label class="meta-label" for="oum_start_zoom">
                                    <?php echo __('Zoom', 'open-user-map'); ?>
                                </label>
                                <input type="text" readonly class="widefat" id="oum_start_zoom" name="oum_start_zoom" value="<?php echo esc_attr($start_zoom) ? esc_attr($start_zoom) : ''; ?>"></input>
                            </div>
                        </div>
            ...
            <?php if ( !oum_fs()->is_plan_or_trial( 'pro' ) || !oum_fs()->is_premium() ) : ?>
              ...
              <tr valign="top">
                <th scope="row">
                  <?php echo __('Geosearch Provider', 'open-user-map'); ?>
                  <br><span class="oum-pro">PRO</span><br>
                  <a class="oum-gopro-text" href="<?php echo oum_fs()->get_upgrade_url(); ?>"><?php echo __('Upgrade to PRO to use Geoapify or Here Maps as address search provider.', 'open-user-map'); ?></a>
                </th>
                <td>
                  <select name="oum_geosearch_provider" id="oum_geosearch_provider">
                    <?php
        ...
        <div id="tab-2" class="tab-pane">
          ...
          <table class="form-table">
            ...
            <tr valign="top">
              ...
              <td>
                <input class="regular-text" type="text" name="oum_form_headline" id="oum_form_headline" placeholder="<?php echo __('Add a new location', 'open-user-map'); ?>" value="<?php echo esc_textarea($oum_form_headline); ?>"></input><br>
              </td>
            </tr>
                  ...
                  <table>
                    ...
                    <?php if(is_array($oum_custom_fields)): ?>
                      <?php foreach($oum_custom_fields as $index => $custom_field): ?>
                        <tr>
                          <td>
                            <input type="text" class="field-type-text field-type-link field-type-email field-type-checkbox field-type-radio field-type-select" name="oum_custom_fields[<?php echo $index; ?>][label]" placeholder="<?php echo __('Enter label', 'open-user-map'); ?>" value="<?php echo esc_attr($custom_field['label']); ?>" />
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <label class="field-type-link oum-custom-field-use-label-as-text"><input class="field-type-link" type="checkbox" name="oum_custom_fields[<?php echo $index; ?>][uselabelastextoption]" <?php echo isset($custom_field['uselabelastextoption']) ? 'checked' : ''; ?> ><?php echo __('use label as text', 'open-user-map'); ?></label>
                  ...
                  <td>
                    <div class="oum_2cols">
                      <div>
                        ...
                        <input class="small-text" type="number" min="1" name="oum_max_image_filesize" id="oum_max_image_filesize" value="<?php echo esc_attr($oum_max_image_filesize); ?>"></input>MB
                      </div>
                      <div>
                        <strong><?php echo __('Audio'); ?>:</strong><br>
                        <input class="small-text" type="number" min="1" name="oum_max_audio_filesize" id="oum_max_audio_filesize" value="<?php echo esc_attr($oum_max_audio_filesize); ?>"></input>MB
                      </div>
                    </div>
                    <br><br>
                  </td>
              ...
              <?php if ( oum_fs()->can_use_premium_code() ): ?>
                ...
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <input class="regular-text" type="text" name="oum_user_notification_subject" id="oum_user_notification_subject" value="<?php echo esc_textarea($oum_user_notification_subject); ?>"></input><br><br>
            ...
            <tr valign="top">
              ...
              <td>
                <input class="regular-text" type="text" name="oum_submit_button_label" id="oum_submit_button_label" placeholder="<?php echo __('Submit location for review', 'open-user-map'); ?>" value="<?php echo esc_textarea($oum_submit_button_label); ?>"></input><br>
              </td>
            </tr>
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <div id="oum_action_after_submit_text">
                  ...
                  ?>
                  <input class="regular-text" type="text" name="oum_thankyou_headline" id="oum_thankyou_headline" placeholder="<?php echo __('Thank you!', 'open-user-map'); ?>" value="<?php echo esc_textarea($oum_thankyou_headline); ?>"></input><br><br>
                  <textarea class="regular-text" name="oum_thankyou_text" id="oum_thankyou_text" rows="4" cols="50" placeholder="<?php echo __('We will check your location suggestion and release it as soon as possible.', 'open-user-map'); ?>"><?php echo esc_textarea($oum_thankyou_text); ?></textarea><br><br>
                </div>
                <div id="oum_action_after_submit_redirect">
                  <?php
                  $oum_thankyou_redirect = get_option('oum_thankyou_redirect');
                  ?>
                  <input class="regular-text" type="text" name="oum_thankyou_redirect" id="oum_thankyou_redirect" placeholder="<?php echo 'https://loremipsum.com'; ?>" value="<?php echo esc_textarea($oum_thankyou_redirect); ?>"></input>
                </div>
              </td>
            </tr>
          ...
          <table class="form-table">
                    ...
                    <div class="wrap-searchbar-settings">
                      ...
                      <div id="oum_searchbar_type_options">
                          ...
                          <label class="oum-gopro-div">
                            ...
                            <strong><?php  echo __('Live Filter Markers', 'open-user-map'); ?></strong>&nbsp;&nbsp;<span class="oum-pro">PRO</span><br>
                            <small><?php echo __('Filter markers live as you type to instantly refine the map view.', 'open-user-map'); ?></small>
                          </label>
                      </div>
                    </div>
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <input class="small-text" type="number" min="1" max="19" name="oum_searchmarkers_zoom" id="oum_searchmarkers_zoom" placeholder="<?php echo esc_attr($this->oum_searchmarkers_zoom_default); ?>" value="<?php echo esc_attr($oum_searchmarkers_zoom); ?>"></input><br><br>
            ...
            <?php if ( !oum_fs()->is_plan_or_trial( 'pro' ) || !oum_fs()->is_premium() ) : ?>
              ...
              <tr valign="top" class="oum-gopro-tr">
                <th scope="row">
                  ...
                  <br><span class="oum-pro">PRO</span><br>
                  <a class="oum-gopro-text" href="<?php echo oum_fs()->get_upgrade_url(); ?>"><?php echo __('Upgrade to PRO and add category filters to the map.', 'open-user-map'); ?></a>
                </th>
                <td>
                  <input class="oum-switch" type="checkbox" disabled>
          ...
          <table class="form-table">
              ...
              <?php if ( oum_fs()->can_use_premium_code() ): ?>
                ...
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <input class="regular-text" type="text" name="oum_admin_notification_email" id="oum_admin_notification_email" value="<?php echo esc_textarea($oum_admin_notification_email); ?>"></input><br><br>

                    <strong><?php echo __('Subject'); ?>:</strong><br>
                    <input class="regular-text" type="text" name="oum_admin_notification_subject" id="oum_admin_notification_subject" value="<?php echo esc_textarea($oum_admin_notification_subject); ?>"></input><br><br>
              ...
              <?php if ( oum_fs()->can_use_premium_code() ): ?>
                ...
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <input class="regular-text" type="text" name="oum_webhook_notification_url" id="oum_webhook_notification_url" value="<?php echo esc_url($oum_webhook_notification_url); ?>"></input>
            ...
            <?php if ( !oum_fs()->is_plan_or_trial( 'pro' ) || !oum_fs()->is_premium() ) : ?>
              ...
              <tr valign="top" class="oum-gopro-tr">
                <th scope="row">
                  <?php echo __('Trigger Webhook on new or updated Locations', 'open-user-map'); ?>
                  <br><span class="oum-pro">PRO</span><br>
                  <a class="oum-gopro-text" href="<?php echo oum_fs()->get_upgrade_url(); ?>"><?php echo __('Upgrade to PRO to trigger external web services (e.g. Zapier) on a new or updated Location.', 'open-user-map'); ?></a>
                </th>
                <td>
                  <input class="oum-switch" type="checkbox" disabled>
                  <label></label><br><br>
            ...
            <tr valign="top" >
                ...
                <td>
                  ...
                  <textarea class="regular-text" name="oum_custom_js" id="oum_custom_js" rows="8" cols="50" placeholder="<?php echo __("e.g. console.log('The map is ready')", "open-user-map"); ?>"><?php echo $oum_custom_js; ?></textarea><br><br>
            ...
            <?php if ( !oum_fs()->is_plan_or_trial( 'pro' ) || !oum_fs()->is_premium() ) : ?>
              ...
              <tr valign="top" class="oum-gopro-tr">
                <th scope="row">
                  <?php echo __('Export all Locations', 'open-user-map'); ?>
                  <br><span class="oum-pro">PRO</span><br>
                  <a class="oum-gopro-text" href="<?php echo oum_fs()->get_upgrade_url(); ?>"><?php echo __('Upgrade to PRO to export your locations.', 'open-user-map'); ?></a>
                </th>
                <td>
                  <button disabled class="button button-secondary"><?php echo __('Export to CSV', 'open-user-map'); ?></button>
                  <br><br>
                  <div class="description">
                    <strong>This is how the export works:</strong><br>
                    <ul>
            ...
            <?php if ( !oum_fs()->is_plan_or_trial( 'pro' ) || !oum_fs()->is_premium() ) : ?>
              ...
              <tr valign="top" class="oum-gopro-tr">
                <th scope="row">
                  <?php echo __('Import all Locations', 'open-user-map'); ?>
                  <br><span class="oum-pro">PRO</span><br>
                  <a class="oum-gopro-text" href="<?php echo oum_fs()->get_upgrade_url(); ?>"><?php echo __('Upgrade to PRO to import your locations.', 'open-user-map'); ?></a>
                </th>
                <td>
                  <div class="csv_upload">
                    <button disabled class="button button-secondary"><?php echo __('Upload CSV & Import', 'open-user-map'); ?></button>
                    <br><br>
                    <div class="description">
                      <strong>This is important to make the import work:</strong><br>
                      <ul>
          ...
          <table class="form-table">
            ...
            <tr valign="top">
              ...
              <td class="top-padding-20">
                ...
                <strong><?php echo __('Shortcode attributes:', 'open-user-map'); ?></strong><br>
                <p class="hint"><?php echo __('You can use shortcode attributes to override the <a href="edit.php?post_type=oum-location&page=open-user-map-settings">global settings</a>. This allows for custom individual maps.', 'open-user-map'); ?></p><br><br>

                <code>lat="51.50665732176545" long="-0.12752251529432854" zoom="13"</code><br>
                <p class="hint"><?php echo __('Set an individual map position with lat, long and zoom.', 'open-user-map'); ?></p><br><br>
                
                <code>types="food|drinks" ids="123"</code><br>
                <p class="hint"><?php echo __('Filter locations by types (Marker Categories) or <a href="https://gigapress.net/how-to-find-a-page-id-or-post-id-in-wordpress/" target="_blank">Post ID</a>. Separate multiple Types or Post IDs with a | symbol.', 'open-user-map'); ?></p><br><br>
                
                <code>size="default|fullwidth" size_mobile="square|landscape|portrait"</code><br>
                <p class="hint"><?php echo __('Set a custom size.', 'open-user-map'); ?></p><br><br>
                
                <code>height="400px" height_mobile="300px"</code><br>
                <p class="hint"><?php echo __('Set a custom height. Don\'t forget to add a unit like <b>px</b>.', 'open-user-map'); ?></p><br><br>

                <code>region="Europe"</code><br>
                <p class="hint"><?php echo __('Pre-select a region.', 'open-user-map'); ?> <?php echo __('This works only if you enabled the regions feature in the settings.', 'open-user-map'); ?></p><br><br>

                <code>map_type="interactive|simple"</code><br>
                <p class="hint"><?php echo __('Enable or disable the "Add location" button.', 'open-user-map'); ?></p><br><br>

                <code>disable_regions="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable Regions.', 'open-user-map'); ?></p><br><br>

                <code>enable_cluster="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable Marker Clustering.', 'open-user-map'); ?></p><br><br>

                <code>enable_searchbar="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable the searchbar.', 'open-user-map'); ?></p><br><br>

                <code>enable_searchaddress_button="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable the "Search for Address (Geosearch)" button.', 'open-user-map'); ?></p><br><br>

                <code>enable_searchmarkers_button="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable the "Search for Markers" button.', 'open-user-map'); ?></p><br><br>

                <code>enable_currentlocation="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable the "Show me where I am" button.', 'open-user-map'); ?></p><br><br>

                <code>enable_fullscreen="true|false"</code><br>
                <p class="hint"><?php echo __('Enable or disable the fullscreen button', 'open-user-map'); ?></p><br><br>
            ...
            <tr valign="top">
              ...
              <td class="top-padding-20">
                ...
                <br><br>
                <span class="hint"><?php echo __('Get a nice gallery view of all the location images. Each image is linked to the location marker on the map. Use the URL attribute to link the images to another page. Use the NUMBER attribute to limit the number of images. Both attributes are optional.', 'open-user-map'); ?></span>
                <br><br><br>
            ...
            <tr valign="top">
              ...
              <td class="top-padding-20">
                <code>?markerid=123</code> <span class="hint"><?php echo __('123 can be the post_id of any public location. Add the parameter to the URL to auto-open a specific location.', 'open-user-map'); ?></span><br><br>
                <code>?region=Europe</code> <span class="hint"><?php echo __('Pre-select a region.', 'open-user-map'); ?> <?php echo __('This works only if you enabled the regions feature in the settings.', 'open-user-map'); ?></span><br><br>
              </td>
            </tr>
  ...
  return $content;
                ...
                <br><br><br>
                <span class="oum-pro">PRO</span> <strong><?php echo __('Customize location list item content:', 'open-user-map'); ?></strong><br><br>
  ...
  return $image;
            ...
            <tr valign="top">
              ...
              <td class="top-padding-20">
                <?php echo  __( 'You can copy & paste this info and send it as email to our support in case we need to debug something:', 'open-user-map' ) ;?><br><br>
                <div class="oum-debug-info">
                  <ul>
                    <li>Plugin: <?php echo get_plugin_data($this->plugin_path . 'open-user-map.php', false)['Name'];?></li>
