        ...
        <table class="form-table">
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <input type="checkbox" id="cbn_enable_add_location" name="cbn_enable_add_location"
                        <?php echo ($cbn_enable_add_location == 'on') ? 'checked' : ''; ?>>
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <input class="regular-text" type="text" name="cbn_map_height_mobile" id="cbn_map_height_mobile"
                           placeholder="e.g. 400px" value="<?php echo esc_attr($cbn_map_height_mobile); ?>"><br><br>
                    <div class="description"><?php echo __('Don\'t forget to add a unit like <b>px</b>.', 'Compass'); ?></div>
                </td>
            </tr>
            <tr class="top">
                        ...
                        <div class="input-wrap">
                            <div class="latlng-wrap">
                                <div class="form-field lat-wrap">
                                    ...
                                    <input type="text" readonly class="widefat" id="cbn_start_lat" name="cbn_start_lat"
                                ...
                                <div class="form-field lng-wrap">
                                    ...
                                    <input type="text" readonly class="widefat" id="cbn_start_lng" name="cbn_start_lng"
                ...
                <td>
                    ...
                    <div class="wrap-geosearch-provider-settings">
                        <div class="geosearch-provider-geoapify">
                            ...
                            <input class="regular-text" type="text" name="cbn_geosearch_provider_geoapify_key"
                        ...
                        <div class="geosearch-provider-here">
                            ...
                            <input class="regular-text" type="text" name="cbn_geosearch_provider_here_key"
                        ...
                        <div class="geosearch-provider-mapbox">
                            <strong><?php echo __('MapBox API Key:', 'Compass'); ?></strong><br>
                            <input class="regular-text" type="text" name="cbn_geosearch_provider_mapbox_key"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    <input class="cbn-switch" type="checkbox" name="cbn_disable_cbn_attribution"
                           id="cbn_disable_cbn_attribution" <?php echo ($cbn_disable_cbn_attribution) ? 'checked' : ''; ?>
    ...
    <div id="tab-2" class="tab-pane">
        <table class="form-table">
            <tr style="vertical-align: top;">
                ...
                <td>
                    <input class="regular-text" type="text" name="cbn_form_headline" id="cbn_form_headline"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <input class="regular-text" type="text" name="cbn_title_label" id="cbn_title_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_map_label" id="cbn_map_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_address_label" id="cbn_address_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <br>
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_description_label" id="cbn_description_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <br><br>
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_upload_media_label" id="cbn_upload_media_label"
                ...
                <td>
                    <div class="cbn_2cols">
                        <div>
                            ...
                            <input class="small-text" type="number" min="1" name="cbn_max_image_filesize"
                                   id="cbn_max_image_filesize"
                                   value="<?php echo esc_attr($cbn_max_image_filesize); ?>">MB
                        </div>
                        <div>
                            <strong><?php echo __('Audio'); ?>:</strong><br>
                            <input class="small-text" type="number" min="1" name="cbn_max_audio_filesize"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_user_notification_label"
                    ...
                    <input class="regular-text" type="text" name="cbn_user_notification_subject"
                    ...
                    <textarea class="regular-text" name="cbn_user_notification_message"
                              id="cbn_user_notification_message" rows="8"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    <input class="regular-text" type="text" name="cbn_submit_button_label" id="cbn_submit_button_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <div id="cbn_action_after_submit_text">
                        ...
                        ?>
                        <input class="regular-text" type="text" name="cbn_thankyou_headline" id="cbn_thankyou_headline"
                               placeholder="<?php echo __('Thank you!', 'Compass'); ?>"
                               value="<?php echo esc_textarea($cbn_thankyou_headline); ?>"><br><br>
                        <textarea class="regular-text" name="cbn_thankyou_text" id="cbn_thankyou_text" rows="4"
                                  cols="50"
        ...
        <table class="form-table">
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_searchaddress_label" id="cbn_searchaddress_label"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                    <input class="regular-text" type="text" name="cbn_searchmarkers_label" id="cbn_searchmarkers_label"
                    ...
                    <input class="small-text" type="number" min="1" max="19" name="cbn_searchmarkers_zoom"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <div class="wrap-marker-categories-settings">
                        <strong><?php echo __('Custom Label:', 'Compass'); ?></strong><br>
                        <input class="regular-text" type="text" name="cbn_marker_types_label"
        ...
        <table class="form-table">
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <input class="regular-text" type="text" name="cbn_admin_notification_email"
                           id="cbn_admin_notification_email"
                           value="<?php echo esc_textarea($cbn_admin_notification_email); ?>"><br><br>
                    <strong><?php echo __('Subject'); ?>:</strong><br>
                    <input class="regular-text" type="text" name="cbn_admin_notification_subject"
                           id="cbn_admin_notification_subject"
                           value="<?php echo esc_textarea($cbn_admin_notification_subject); ?>"><br><br>
                    <strong><?php echo __('Message'); ?>:</strong><br>
                    <textarea class="regular-text" name="cbn_admin_notification_message"
                              id="cbn_admin_notification_message" rows="8"
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <input class="regular-text" type="text" name="cbn_webhook_notification_url"
                    ...
                    <div class="csv_upload">
                        ...
                        <div class="description">
                            ...
                            <ul>
                                ...
                                <li>Be aware that every location with matching POST ID will be overwritten. <span
