...
<div class="box-wrap map-size-<?php echo esc_attr($map_size); ?> <?php if($cbn_enable_regions == 'on' && $regions && count($regions) > 0): ?>cbn-regions-<?php echo $cbn_regions_layout_style; ?> <?php endif; ?>">
