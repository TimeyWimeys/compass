...
<div class="box-wrap map-size-<?php echo esc_attr($map_size); ?> <?php if ($oum_enable_regions == 'on' && $regions && count($regions) > 0): ?>oum-regions-<?php echo $oum_regions_layout_style; ?> <?php endif; ?>">
        ...
        <div class="tab-wrap">
            <div class="oum-tabs" id="nav-tab-<?php echo $unique_id; ?>" role="tablist">
                ...
                <?php foreach ($regions as $region): ?>
                    ...
                    ?>
                    <div class="nav-item nav-link <?php echo (isset($oum_start_region_name) && $name == $oum_start_region_name) ? 'active' : ''; ?> change_region"
                         data-lat="<?php echo esc_attr($term_lat); ?>" data-lng="<?php echo esc_attr($term_lng); ?>"
                         data-zoom="<?php echo esc_attr($term_zoom); ?>" data-toggle="tab"
                         role="tab"><?php echo esc_html($name); ?></div>
    ...
    <div class="map-wrap">
        ...
        <?php if ($oum_enable_searchbar === 'true' && $oum_searchbar_type == 'live_filter'): ?>
            <label for="oum_filter_markers"></label><input type="text" id="oum_filter_markers" class="oum-hidden"
                                                           placeholder="<?php echo esc_attr($oum_searchmarkers_label); ?>"/>
        <?php endif; ?>
                    ...
                    <?php if (get_option('oum_enable_user_restriction')): ?>
                        ...
                        <?php if (is_user_logged_in()): ?>
                            ...
                            <div id="open-add-location-overlay" class="open-add-location-overlay oum-hidden"
                                 style="background-color: <?php echo $oum_ui_color; ?>"><span
                                        class="btn_icon">+</span><span
                                        class="btn_text"><?php echo esc_attr($oum_plus_button_label); ?></span></div>

                        <?php elseif (!is_user_logged_in() && get_option('oum_enable_redirect_to_registration')): ?>

                            <a href="<?php echo wp_registration_url(); ?>" class="open-add-location-overlay oum-hidden"
                               style="background-color: <?php echo $oum_ui_color; ?>"><span
                                        class="btn_icon">+</span><span
                                        class="btn_text"><?php echo esc_attr($oum_plus_button_label); ?></span></a>
            ...
            <div class="oum-filter-controls <?php echo $oum_collapse_filter; ?> oum-hidden">
                ...
                <div class="oum-filter-list">
                    ...
                    <?php foreach ($types as $type): ?>
                        ...
                        <label>
                            <input style="accent-color: <?php echo $oum_ui_color; ?>" type="checkbox" name="type"
                                   value="<?php echo esc_attr($type->term_taxonomy_id); ?>" checked>
