window.addEventListener('load', function(e) {
  ...
  const existingImages = jQuery('#cbn_location_image').val();
  if (existingImages) {
  ...
  function setAddress(label) {
    jQuery('#cbn_location_address').val(label);
  }
  ...
  jQuery('#cbn_location_image_preview').closest('form').on('click', '.cbn_upload_image_button', function(e) {
    ...
    image_uploader.on('select', function() {
      ...
      const maxImages = 5;
      const existingImages = jQuery('#cbn_location_image_preview img').length;
  ...
  function updateImagePreview(imageUrls) {
    const previewContainer = jQuery('#cbn_location_image_preview');
  ...
  function updatePlaceholderPosition(e) {
    const gridContainer = document.querySelector("#cbn_location_image_preview .image-preview-grid");
  ...
  jQuery('body').on('click', '.remove-image', function(e) {
    ...
    const currentUrls = jQuery('#cbn_location_image').val().split('|');
