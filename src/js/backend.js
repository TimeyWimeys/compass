...
function oumRemoveVideoUpload() {
    document.getElementById('cbn_location_video').value = '';
    document.getElementById('cbn_location_video_preview').classList.remove('has-video');
    document.getElementById('cbn_location_video_preview').textContent = '';
}
