...
class BaseController
{
    ...
    public array $marker_icons = [
        'default', 'custom1', 'custom2', 'custom3', 'custom4', 'custom5', 'custom6', 'custom7', 'custom8', 'custom9', 'custom10'
    ];

    public array $oum_map_sizes = [
        'default' => 'Content width',
        'fullwidth' => 'Full width'
    ];

    public array $pro_marker_icons = [
        'user1'
    ];

    public string $oum_ui_color_default = '#e02aaf';

    public array $oum_custom_field_fieldtypes = [
        'text' => 'Text'
    ];

    public array $pro_oum_custom_field_fieldtypes = [
        'link' => 'Link [PRO]',
        'email' => 'Email [PRO]',
    ...
    public array $oum_geosearch_provider = [
        'osm' => 'Open Street Map'
    ];

    public array $pro_oum_geosearch_provider = [
        'geoapify' => 'Geoapify [PRO]',
        'here' => 'Here [PRO]',
        'mapbox' => 'MapBox [PRO]'
    ];

    public array $oum_searchbar_types = [
        'address' => 'Search for Address (Geosearch)',
        'markers' => 'Search for Location Marker',
    ];

    public array $pro_oum_searchbar_types = [
        'live_filter' => 'Live Filter Markers'
    ];

    public array $oum_regions_layout_styles = [
        'layout-1' => 'Top',
        'layout-2' => 'Sidebar'
    ];

    public array $oum_incompatible_3rd_party_scripts = [
    ...
    public function __construct()
    {
        ...
        $this->plugin_version = get_file_data(dirname(__FILE__, 3) . '/open-user-map.php', ['Version' => 'Version'])['Version'];
        ...
        add_action('init', [$this, 'oum_init']);

        if (oum_fs()->is__premium_only()):
            if (oum_fs()->can_use_premium_code()):

                add_action('transition_post_status', [$this, 'notify_author__premium_only'], 10, 3);
                add_action('wp_insert_post', [$this, 'notify_admin__premium_only'], 10, 3);
            ...
            if (oum_fs()->can_use_premium_code()):
                ...
                if (get_option('oum_enable_user_restriction')):
                    if (is_user_logged_in()):
                        ...
                        add_action('wp_ajax_nopriv_oum_add_location_from_frontend', [$this, 'ajax_add_location_from_frontend']);
                        add_action('wp_ajax_oum_add_location_from_frontend', [$this, 'ajax_add_location_from_frontend']);
    ...
    public function include_map_scripts(): void
    {
        ...
        // enqueue Leaflet css
        wp_enqueue_style('oum_leaflet_css', $this->plugin_url . 'src/leaflet/leaflet.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_gesture_css', $this->plugin_url . 'src/leaflet/leaflet-gesture-handling.min.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_markercluster_css', $this->plugin_url . 'src/leaflet/leaflet-markercluster.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_markercluster_default_css', $this->plugin_url . 'src/leaflet/leaflet-markercluster.default.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_geosearch_css', $this->plugin_url . 'src/leaflet/geosearch.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_fullscreen_css', $this->plugin_url . 'src/leaflet/control.fullscreen.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_locate_css', $this->plugin_url . 'src/leaflet/leaflet-locate.min.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_search_css', $this->plugin_url . 'src/leaflet/leaflet-search.css', [], $this->plugin_version);
        wp_enqueue_style('oum_leaflet_responsivepopup_css', $this->plugin_url . 'src/leaflet/leaflet-responsive-popup.css', [], $this->plugin_version);

        // Add map loader script first (before any other scripts)
        wp_enqueue_script('oum_map_loader_js', $this->plugin_url . 'src/js/frontend-map-loader.js', [], $this->plugin_version, true);

        // enqueue Leaflet javascripts
        wp_enqueue_script('oum_leaflet_polyfill_unfetch_js', $this->plugin_url . 'src/js/polyfills/unfetch.js', [], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_js', $this->plugin_url . 'src/leaflet/leaflet.js', ['oum_leaflet_polyfill_unfetch_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_providers_js', $this->plugin_url . 'src/leaflet/leaflet-providers.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_markercluster_js', $this->plugin_url . 'src/leaflet/leaflet-markercluster.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_subgroups_js', $this->plugin_url . 'src/leaflet/leaflet.featuregroup.subgroup.js', ['oum_leaflet_js', 'oum_leaflet_markercluster_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_geosearch_js', $this->plugin_url . 'src/leaflet/geosearch.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_locate_js', $this->plugin_url . 'src/leaflet/leaflet-locate.min.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_fullscreen_js', $this->plugin_url . 'src/leaflet/control.fullscreen.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_search_js', $this->plugin_url . 'src/leaflet/leaflet-search.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_gesture_js', $this->plugin_url . 'src/leaflet/leaflet-gesture-handling.min.js', ['oum_leaflet_js'], $this->plugin_version, true);
        wp_enqueue_script('oum_leaflet_responsivepopup_js', $this->plugin_url . 'src/leaflet/leaflet-responsive-popup.js', ['oum_leaflet_js'], $this->plugin_version, true);

        // Capture the fully extended L object after all Leaflet add-ons are loaded
        wp_enqueue_script('oum_global_leaflet_js', $this->plugin_url . 'src/leaflet/oum-global-leaflet.js', ['oum_leaflet_js'], $this->plugin_version, true);
    ...
    {
        wp_enqueue_style('oum_frontend_css', $this->plugin_url . 'assets/frontend.css', [], $this->plugin_version);

        // load map base scripts
        $this->include_map_scripts();

        wp_enqueue_script('oum_frontend_block_map_js', $this->plugin_url . 'src/js/frontend-block-map.js', ['oum_leaflet_providers_js', 'oum_leaflet_markercluster_js', 'oum_leaflet_subgroups_js', 'oum_leaflet_geosearch_js', 'oum_leaflet_locate_js', 'oum_leaflet_fullscreen_js', 'oum_leaflet_search_js', 'oum_leaflet_gesture_js', 'wp-i18n', 'oum_global_leaflet_js'], $this->plugin_version, true);

        // add custom js to frontend-block-map.js
        wp_localize_script('oum_frontend_block_map_js', 'custom_js', [
            'snippet' => get_option('oum_custom_js'),
        ]);

        wp_enqueue_script('oum_frontend_ajax_js', $this->plugin_url . 'src/js/frontend-ajax.js', ['jquery', 'oum_frontend_block_map_js'], $this->plugin_version, true);
        wp_localize_script('oum_frontend_ajax_js', 'oum_ajax', [
            'ajaxurl' => admin_url('admin-ajax.php'),
        ]);

        // Enqueue carousel script
        wp_enqueue_script('oum_frontend_carousel_js', $this->plugin_url . 'src/js/frontend-carousel.js', [], $this->plugin_version, true);
     ...
     */
    #[NoReturn] public function ajax_add_location_from_frontend(): void
    {
        if (!empty($_POST['action']) && $_POST['action'] == 'oum_add_location_from_frontend') {
            ...
            $data['oum_location_notification'] = $_POST['oum_location_notification'] ?? '';
            ...
            if (isset($_POST['oum_location_custom_fields']) && is_array($_POST['oum_location_custom_fields'])) {
                $data['oum_location_custom_fields'] = [];
            ...
            if (isset($_FILES['oum_location_audio']['name']) && $_FILES['oum_location_audio']['name'] != '') {
                $valid_extensions = ['mp3', 'wav', 'mp4', 'm4a']; // valid extensions
            ...
            if ($error->has_errors()) {
                ...
                if (isset($data['oum_delete_location']) && $data['oum_delete_location'] == 'true') {
                    ...
                    if ($post_id) {
                        ...
                        $final_image_urls = [];
                        $image_order = isset($_POST['image_order']) ? json_decode(stripslashes($_POST['image_order']), true) : [];
                        $new_image_mapping = []; // Store mapping of original filename to new URL
    ...
    public function trigger_webhook($post_id, $event_type, $data_meta = null): void
    {
        ...
        $webhook_data = [
            ...
            'taxonomy_terms' => wp_get_post_terms($post_id, 'oum-type', ['fields' => 'names']),
    ...
    public function render_block_add_user_location__premium_only(): void
    {
        ...
        wp_enqueue_script('oum_frontend_block_map_js', $this->plugin_url . 'src/js/frontend-block-add-user-location.js', ['oum_leaflet_providers_js', 'oum_leaflet_markercluster_js', 'oum_leaflet_subgroups_js', 'oum_leaflet_geosearch_js', 'oum_leaflet_locate_js', 'oum_leaflet_fullscreen_js', 'oum_leaflet_search_js', 'oum_leaflet_gesture_js', 'wp-i18n', 'oum_global_leaflet_js'], $this->plugin_version, true);
    }
    ...
    public function render_block_gallery__premium_only($block_attributes, $content): false|string
    {
        ...
        wp_enqueue_script('oum_gallery_js', $this->plugin_url . 'src/js/frontend-gallery.js', ['jquery', 'masonry', 'imagesloaded'], $this->plugin_version, true);
    ...
    public function render_block_location__premium_only($block_attributes, $content): false|string
    {
        ...
        if (isset($block_attributes['value']) && $block_attributes['value'] == 'map') {
            ...
            wp_enqueue_script('oum_frontend_block_location_js', $this->plugin_url . 'src/js/frontend-block-location.js', ['oum_leaflet_providers_js', 'oum_leaflet_markercluster_js', 'oum_leaflet_subgroups_js', 'oum_leaflet_geosearch_js', 'oum_leaflet_locate_js', 'oum_leaflet_fullscreen_js', 'oum_leaflet_search_js', 'oum_leaflet_gesture_js', 'wp-i18n', 'oum_global_leaflet_js'], $this->plugin_version, true);
        }
