...
class BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->plugin_version = get_file_data(dirname(__FILE__, 3) . '/Compass.php', ['Version' => 'Version'])['Version'];
    ...
    public function render_block_map(): false|string
    {
        ...
        wp_localize_script('cbn_frontend_block_map_js', 'custom_js', [
        ...
        wp_localize_script('cbn_frontend_ajax_js', 'cbn_ajax', [
