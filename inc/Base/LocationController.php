        ...
        if($attr == 'title') {
            ...
            if($has_image) {
                ...
                if(count($images) > 1 && !$raw) {
                    ...
                    wp_enqueue_style('oum_frontend_css', plugin_dir_url(dirname(dirname(__FILE__))) . 'assets/frontend.css', array(), $this->plugin_version);
                    wp_enqueue_script('oum_frontend_carousel_js', plugin_dir_url(dirname(dirname(__FILE__))) . 'src/js/frontend-carousel.js', array(), $this->plugin_version);
