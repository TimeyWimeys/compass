        ...
        <>
            <InspectorControls>
                <PanelBody title={__('Custom Map Position', 'open-user-map')} initialOpen={false}>
                    ...
                    <PanelRow>
                        <p>{__('This will override the general configuration from the', 'open-user-map')} <a
                            href="edit.php?post_type=oum-location&page=open-user-map-settings">{__('settings', 'open-user-map')}</a>.
                        </p>
                    </PanelRow>
                    <PanelRow>
                        <TextControl
